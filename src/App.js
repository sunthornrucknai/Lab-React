...
function App() {
  return (
    <div>
      <h1 className="animate__animated  animate__slideInDown">เกม24 หรรษา</h1>
      <h3 className="animate__animated animate__lightSpeedInRight">วิธีการเล่น นี้คือเกม24อย่างง่าย คือเป็นเกมทางคณิตศาสตร์ที่จะมีตัวเลขมาให้ทั้งหมด 4 ตัว 
      ...
      <h2 className="animate__animated animate__bounceIn animate__delay-2s">ขอยอมแพ้ ดูเฉลย!!</h2>
